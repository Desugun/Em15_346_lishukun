set_property PACKAGE_PIN W20 [get_ports {btns_4bit_tri_i[3]}]
...
set_property PACKAGE_PIN T10 [get_ports {sw_4bit_tri_o[0]}]
set_property PACKAGE_PIN R14 [get_ports {sw_4bit_tri_o[1]}]
set_property PACKAGE_PIN H15 [get_ports {sw_4bit_tri_o[2]}]
set_property PACKAGE_PIN W19 [get_ports {sw_4bit_tri_o[3]}]
